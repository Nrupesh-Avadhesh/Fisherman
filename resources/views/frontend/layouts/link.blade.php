    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontend/assets/imgs/favicon.png') }}">
    <!-- CSS here -->
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/vendor/flaticon_finwise.css') }}">
