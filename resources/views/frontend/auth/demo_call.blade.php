...
@section('content')
    <section class="login__area section-space">
        <div class="container">
            <input type="hidden" id="block_list" value="{{ $block_list }}">
            {!! Form::open(['url' => action('App\Http\Controllers\frontend\loginController@deom_store'), 'method' => 'post','files'=>true, 'id' => 'company_add_form', 'class' => 'form-horizontal' ,'enctype' => 'multipart/form-data']) !!}
                <div id="profile">
                    <div class="login__wrapper text-center mx-auto mt-20">
                        <div class="login__intro mb-40">
                            <h3 class="login__title">Personal Information</h3>
                        </div>
                ...
                <div id="investment" style=" display: none; ">
                    <div class="login__wrapper text-center mx-auto mt-20">
                        <div class="login__intro mb-40">
                            <h3 class="login__title">Investment Amount </h3>
                        </div>
                        <section class="contact__area  mb-20" style=" padding: 0; ">
                            <div class="contact__wrapper" style=" padding: 0; ">
                                <div class="contact__form">

                                    <div class="contact__input-box mb-15 mb-20 p-5">
                                        <div class="contact__input-title">
                                            <label>How much Money you investing?*</label>
                                        </div>
                                        <div class="login__input">
                                            <select name="investment_amount" class="form-control" style="height: 60px; font-size: 18px; background-color: #202020; color: #6e6f73; border-color: #6e6e6e; ">
                                                <option value="$1500 - $5000">$1500 - $5000 USD</option>
                                                <option value="$5000 - $15000">$5000 - $15000 USD</option>
                                                <option value="$15000 - $25000">$15000 - $25000 USD</option>
                                                <option value="$25000 - $50000">$25000 - $50000 USD</option>
                                                <option value="$50000 - More">$50000 - More USD</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="login__submit mb-25">
                            <input type="button" class="bd-gradient-btn w-25 investment" value="next">
                        </div>
                    </div>
                </div>
                ...
                <div id="schedule" style=" display: none; ">
                    <div class="login__wrapper text-center mx-auto mt-20">
                        <div class="login__intro mb-40">
                            <h3 class="login__title">Call Schedule</h3>
                        </div>
                        <div class="login__input mb-25">
                            <div class="login__input mb-25">
                                <input type="date" name="date"  id="date" min="{{ date('Y-m-d') }}" style="width: 100%;padding: 10px;color: #fff;" placeholder="Select Date">
                                <span class="error text-danger" id="date_error" style="display: none;"></span>
                            </div>
                            <div class="login__input mb-25">
                                <select name="time" id="time" class="form-control" style="height: 60px; font-size: 18px; background-color: #202020; color: #6e6f73; border-color: #6e6e6e; ">
                                    <option value="">select time slote</option>
                                </select>
                                {{-- <input type="time" name="time" id="time" min="{{ date('H:i') }}" style="width: 100%;padding: 10px;color: #fff;"> --}}
                                <span class="error text-danger" id="time_error" style="display: none;"></span>
                            </div>
                            <p></p>
                        </div>
                        <div class="login__submit mb-25">
                            <input type="button" class="bd-gradient-btn w-25 schedule" value="Schedule">
                        </div>
                    </div>
                </div>
                <div id="thankyou" style=" display: none; ">
                    <div class="login__wrapper text-center mx-auto mt-20">
                        ...
                        <div class="login__input mb-25">
                            <p> Your Call Scheduled request added successfully. </p>
                            {{-- <p> Your Call was Scheduled successfully. </p> --}}
                            <p>An email receipt including the details about your Call has been sent to the email address 
                                <br>Please check it for updates</p>
                        </div>

                        <div class="login__submit mb-25">
                            <input type="button" class="bd-gradient-btn w-25 thankyou" value="Done">
                        </div>
                    </div>
                </div>
            {!! Form::close() !!}
