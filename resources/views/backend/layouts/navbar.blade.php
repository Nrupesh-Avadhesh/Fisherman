<nav class="navbar header-navbar pcoded-header">
    <div class="navbar-wrapper">
        ...
        <div class="justify-content-between navbar-logo">
            ...
            <ul class="nav-right">
                <li class="header-notification d-none">
                    <div class="dropdown-primary dropdown">
                        ...
                        <ul class="show-notification notification-view dropdown-menu d-none" data-dropdown-in="fadeIn"
                        ...
                        <ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn"
                            ...
                            <li>
                                <form method="POST" action="{{ route('superAdmin.logout') }}">
                                    @csrf
                                    <a href="{{ url('/superAdmin/logout') }}" onclick="event.preventDefault(); this.closest('form').submit();"><i class="feather icon-log-out"></i> Logout </a>
                                </form>
                            </li>
                        </ul>
