...
<!-- radial chart.css -->
<link rel="stylesheet" href="{{ asset('assets\pages\chart\radial\css\radial.css') }}" type="text/css"
    media="all">
<!-- feather Awesome -->
...
{{-- <link rel="stylesheet" type="text/css" href="{{ asset('assets\css\toastify.min.css') }}"> --}}
...
<link href="{{ asset('assets/css/e_to_g.css') }}" rel="stylesheet">